    ...
    public class SecondActivity extends AppCompatActivity {
        ...
        private EditText addReviewEdit;
        private RatingBar addRatingBar;
        private TextView mostVotedTextView;
        private EditText addArtworkEdit;
        private RatingBar mostVotedRatingBar;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            addArtworkEdit = findViewById(R.id.add_artwork_edit); // 작품명을 입력받을 EditText 추가


            btnReturn = findViewById(R.id.btnReturn);

            //mostVotedTextView = findViewById(R.id.mostVotedTextView);
            mostVotedImageView = findViewById(R.id.mostVotedImageView);
            mostVotedRatingBar = findViewById(R.id.add_rating_bar);
            ...
            btnReturn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    String artworkName = addArtworkEdit.getText().toString();; // 작품명은 빈 문자열로 설정
            ...
            mostVotedRatingBar.setRating(voteResult[maxEntry]);
        }
    }
